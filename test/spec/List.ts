...
describe('Test of List-implementation', function () {
    var getFilledList = function () {
        var users = GetUsers();
        var list = new dotNeTS.Collections.Generic.List<User>();
        list.Add(users[0]);
        list.Add(users[1]);
        list.Add(users[2]);
        return list;
    ...
    it('Add constructor', function () {
        var users = GetUsers();
        var list = new dotNeTS.Collections.Generic.List<User>(users);
    ...
    it('Single without predicate', function () {
        var users = new dotNeTS.Collections.Generic.List<User>([GetUser()]);
